...
<html lang="en">
    ...
    <body>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="border-0 pl-0">
                        ...
                        @endif
                        <p>Référence: <strong>{{ $invoice->getSerialNumber() }}</strong></p>
        ...
        <table class="table table-items">
            <thead>
                <tr>
                    ...
                    <th scope="col" class="text-right border-0">Prix unitaire HTVA</th>
                    @if($invoice->hasItemDiscount)
                        <th scope="col" class="text-right border-0">Réduction</th>
                    @endif
                    @if($invoice->hasItemTax)
                        <th scope="col" class="text-right border-0">Taxe</th>
                    @endif
            ...
            <tbody>
                ...
                @if($invoice->hasItemOrInvoiceDiscount())
                    <tr>
                        ...
                        <td class="text-right pl-0">Total réductions</td>
                        <td class="text-right pr-0">
        ...
        <p>
            Veuillez payer avant le: {{ $invoice->getPayUntilDate() }}
        </p>
